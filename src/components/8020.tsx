...
const TICKERS: Price[] = [
  { symbol: 'BTC', tradingViewSymbol: 'BINANCE:BTCUSDT', exchange: 'BINANCE', color: 'text-yellow-500' },
  { symbol: 'MSTR', tradingViewSymbol: 'NASDAQ:MSTR', exchange: 'NASDAQ', color: 'text-yellow-500' },
  { symbol: 'MSTU', tradingViewSymbol: 'CBOE:MSTU', exchange: 'CBOE', color: 'text-yellow-500' },
  { symbol: 'MSTX', tradingViewSymbol: 'NASDAQ:MSTX', exchange: 'NASDAQ', color: 'text-yellow-500' },
  { symbol: 'MSTY', tradingViewSymbol: 'AMEX:MSTY', exchange: 'AMEX', color: 'text-yellow-500' },
  { symbol: 'IMST', tradingViewSymbol: 'AMEX:IMST', exchange: 'AMEX', color: 'text-yellow-500' },
  ...
  { symbol: 'BMAX', tradingViewSymbol: 'NASDAQ:BMAX', exchange: 'NASDAQ', color: 'text-yellow-500' },
];

export default function BTC8020Ticker() {
