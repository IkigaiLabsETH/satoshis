...
export default function Grok420Page() {
  ...
  const samplePrompts = [
    ...
    'Bitcoin logo in Van Gogh style, Japanese calligraphy brush strokes, cinematic depth of field, golden hour lighting, impressionist texture, traditional sumi-e ink painting technique, Starry Night color palette, Japanese zen philosophy',
    'A golden Bitcoin in outer space, Kubrick-inspired composition, Japanese minimalism, cosmic lighting, artistic depth, 2001: A Space Odyssey aesthetic, zen garden influence, IMAX cinematography, cosmic dust particles, minimalist Japanese design principles',
    ...
    'Bitcoin as a physical coin on a treasure map, Japanese ukiyo-e style, cinematic lighting, artistic composition, traditional Japanese paper texture, Hokusai wave influence, aged parchment effect, Edo period aesthetics, traditional gold leaf technique',
    'A surreal landscape with Bitcoin-shaped mountains, Miyazaki-inspired, cinematic wide shot, dreamlike atmosphere, Studio Ghibli color palette, Japanese watercolor technique, Spirited Away bathhouse lighting, dream sequence cinematography, ethereal mist effects',
  ];
