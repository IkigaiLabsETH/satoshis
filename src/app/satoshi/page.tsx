...
export default function SatoshiTestPage() {
  ...
  const modes = [
    ...
    { value: 'viral_creator', label: 'Viral Creator' },
    { value: 'enhanced_viral_creator', label: 'Enhanced Viral Creator' },
    { value: 'platform_adaptation', label: 'Platform Adaptation' },
    { value: 'multi_platform_strategy', label: 'Multi-Platform Strategy' },
